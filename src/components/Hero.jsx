...
// Import new hero image
import heroImg from '../assets/images/MOU Images/23.jpeg';
  ...
  return (
    <div className="relative min-h-screen flex flex-col overflow-hidden pt-[74px]">
      ...
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-[270px_1fr_250px] gap-5 items-end px-12 pb-[52px] -mt-[16px]">
        ...
        >
          <div className="w-full max-w-[280px] aspect-[10/11] relative bg-gradient-to-br from-[#143080] to-[#0c1d60] rounded-[22px] shadow-[0_40px_80px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.08)] flex items-center justify-center flex-col gap-2 overflow-hidden mx-auto border-4 border-[#1565f5]/20">
            ...
            />
            <div className="font-semibold text-white text-[0.8rem] absolute bottom-[34px] z-10 drop-shadow-md">Partnership Excellence</div>
            <div className="absolute bottom-[12px] bg-white/10 border border-white/12 px-2.5 py-0.5 rounded-lg text-[0.6rem] text-white/65 z-10">✦ Empowering Futures</div>
          </div>
        </motion.div>
